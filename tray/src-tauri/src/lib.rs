...
use taskscape_common::{
    attachments, hotkeys, names, screenshot, server, List, Store, MAIN_PORT, TRAY_PORT,
};
...
fn global_hotkeys() -> &'static Mutex<GlobalHotkeys> {
...
fn key_code(key: &str) -> Option<Code> {
    ...
    Some(match key {
        ...
        "Enter" => Enter, "Backspace" => Backspace, "Delete" => Delete, "Space" => Space,
        "Tab" => Tab, "Escape" => Escape,
        "ArrowUp" => ArrowUp, "ArrowDown" => ArrowDown,
        "ArrowLeft" => ArrowLeft, "ArrowRight" => ArrowRight,
        "," => Comma, "\\" => Backslash, "/" => Slash, "." => Period, ";" => Semicolon,
...
fn refresh_global_shortcuts(app: AppHandle) {
