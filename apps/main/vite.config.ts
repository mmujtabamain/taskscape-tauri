...
const uiSrc = fileURLToPath(
  new URL("../../packages/common-ui/src", import.meta.url),
);
...
export default defineConfig(async () => ({
  ...
  resolve: {
    // Shared widgets in ../../packages/common-ui/src, resolved from source
  ...
  server: {
    ...
    strictPort: true,
    host: host || false,
    // Serve the shared packages/common-ui sources that live above the app root.
    fs: { allow: [repoRoot] },
    hmr: host
      ? {
          protocol: "ws",
