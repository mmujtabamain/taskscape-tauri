...
const ADJECTIVES: &[&str] = &[
    "Amber", "Arctic", "Autumn", "Breezy", "Bright", "Calm", "Cedar", "Clear", "Cloudy", "Coastal",
    "Cosmic", "Crimson", "Crisp", "Dappled", "Dewy", "Dusky", "Emerald", "Fabled", "Faded", "Fern",
    "Frosty", "Gilded", "Golden", "Hazy", "Hidden", "Hollow", "Indigo", "Ivory", "Jade", "Lively",
    "Lunar", "Misty", "Mossy", "Noble", "Northern", "Opal", "Pale", "Quiet", "Rustic", "Sable",
    "Sandy", "Silent", "Silver", "Solar", "Sunny", "Swift", "Tidal", "Velvet", "Verdant", "Wild",
];

const NOUNS: &[&str] = &[
    "Atlas", "Basin", "Bay", "Bluff", "Brook", "Canyon", "Cape", "Cavern", "Cliff", "Cove",
    "Creek", "Delta", "Dune", "Fjord", "Forest", "Gap", "Glacier", "Glade", "Grove", "Harbor",
    "Heath", "Hill", "Hollow", "Isle", "Knoll", "Lagoon", "Lake", "Meadow", "Mesa", "Moor",
    "Oasis", "Orchard", "Pass", "Peak", "Pine", "Plain", "Prairie", "Range", "Reef", "Ridge",
