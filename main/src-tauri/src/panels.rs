...
/// radius 7, 1.5pt stroke in `--edge-3`, centered), so the handoff to the HTML
/// box is invisible: the opaque page simply paints over it. Removed later via
/// the `boot_done` command.
#[cfg(target_os = "macos")]
